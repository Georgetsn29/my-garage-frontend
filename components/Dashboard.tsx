...
export default function Dashboard({ onLogout }: { onLogout: () => void }) {
  ...
  const renderCarCard = (car: Car, i: number) => (
    <motion.div
      ...
      key={car.id}
      className={`${car.color} border-6 border-black rounded-[3rem] p-8 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] hover:shadow-[24px_24px_0px_0px_rgba(0,0,0,1)] relative overflow-hidden group transition-shadow`}
    >
  ...
  return (
    ...
    >
      <header className="flex flex-col md:flex-row justify-between items-center mb-12 bg-white border-6 border-black p-8 rounded-[3rem] shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] transform -rotate-1">
        <h1 
        ...
        <motion.button
          ...
          onClick={onLogout}
          className="bg-[#FF5722] p-4 rounded-2xl border-6 border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] hover:shadow-[0px_0px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[8px] hover:translate-y-[8px] transition-all"
          title="Logout"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
        ...
        <motion.button
          ...
          className="bg-[#00E676] flex items-center justify-center gap-4 text-3xl font-black uppercase px-8 py-6 rounded-[2rem] border-6 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[8px] hover:translate-y-[8px] transition-all h-full"
        >
